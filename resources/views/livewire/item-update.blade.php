    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header "><h5>update Your Missing Item</h5>
                    <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" wire:model="connectyu_username" class="form-control"
                                               placeholder=" ConnectYU Username" value="{{$item->connectyu_username}}">
                                        @error('connectyu_username') <span
                                            class="text-danger alert-danger">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" wire:model="description" rows="3" > {{$item->description}}</textarea>
